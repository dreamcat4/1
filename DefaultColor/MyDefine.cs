...
namespace DefaultColor
{
    ...
    {
        public const double height = 550;
        public const double level0_x = 500;
        public const double level1_x = 521;
        public const double level2_x = 542;
        public const double level3_x = 563;
        public const double level4_x = 584;
        public const double level5_x = 605;
        public const double level6_x = 626;
        public const double level7_x = 647;
        public const double level8_x = 668;
        public const double level9_x = 689;
